    ...
    <div className="flex min-h-screen bg-white font-sans">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                {...register("password", {
                  required: "Secure password is required",
                })}
              />
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <button
                onClick={() => {
                  login({ email: "admin@medicore.com", password: "admin123" });
                }}
              ...
              <button
                onClick={() => {
                  login({ email: "ahmed@medicore.com", password: "doctor123" });
                }}
                className="rounded-xl bg-white p-3 text-[10px] font-bold text-slate-600 shadow-sm border border-slate-100 transition-all hover:border-brand-500 hover:text-brand-600"
              >
                Doctor
              ...
              <button
                onClick={() => {
                  login({ email: "youssef@email.com", password: "patient123" });
                }}
                className="rounded-xl bg-white p-3 text-[10px] font-bold text-slate-600 shadow-sm border border-slate-100 transition-all hover:border-brand-500 hover:text-brand-600"
              >
                Patient
      ...
      <div className="hidden lg:relative lg:flex lg:w-1/2 lg:items-center lg:justify-center bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          >
            The future of <br />{" "}
            <span className="text-brand-400">clinic management</span> is here.
          </motion.h3>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            A high-performance workspace designed <br /> for high-performance
            medical teams.
          </motion.p>
        </div>
