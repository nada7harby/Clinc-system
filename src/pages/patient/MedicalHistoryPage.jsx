    ...
    <div className="space-y-10 pb-12">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-black text-slate-900 uppercase tracking-tight">
            Medical History
          </h1>
        ...
        <div className="flex gap-4">
          <Button
            ...
            onClick={() => toast("Exporting medical history...")}
          >
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-32 rounded-[40px] bg-slate-50 border-2 border-dashed border-slate-200">
          ...
          <p className="text-slate-300 font-medium mt-1">
            Your visit history will appear here once you complete an
            appointment.
          </p>
        </div>
      ) : (
          ...
          {history.map((visit, idx) => (
            ...
            >
              ...
              <div className="w-full pl-6 md:w-[45%] md:pl-0">
                <Card
                  variant="premium"
                  className="group overflow-hidden border-slate-100 bg-white/80 transition-all hover:border-brand-200 hover:shadow-lg"
                >
                    ...
                    <div className="space-y-4">
                      <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
                        ...
                        <p className="mt-2 text-sm font-medium leading-relaxed text-slate-700">
                          {visit.notes ||
                            "Standard check-up completed. Patient stable."}
                        </p>
                      </div>
              ...
              <div className="hidden md:block w-[45%]">
                <div className="relative overflow-hidden rounded-3xl border border-slate-100 bg-white/70 p-6 shadow-sm">
                  ...
                  <div className="relative flex items-start justify-between">
                    ...
                    <span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-3 py-1 text-[9px] font-black uppercase tracking-widest text-emerald-700">
                      Completed
                    </span>
                  </div>
